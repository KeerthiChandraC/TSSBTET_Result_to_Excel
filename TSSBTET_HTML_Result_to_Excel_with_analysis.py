...
def rsultAnaly(df,fname):
    ...
    fail =  total - pas
    data_dict = {f"{fname}":["Total Students:","Overall No of Passed Students:","Overall No of Failed Students:", "Overall Pass Percentage:"],
        ...
        for sub in subList:
            ...
            for c in col:                
                if "_status" in c:
                    ...
                    resAnal_sheet.cell(row=res_row_pad, column=res_col_pad).value = f'{res_row_pad-7}'
