...
##    sheet_work.cell(row=rowmax+7, column=colmnr).alignment = Alignment(wrap_text=True)
##    sheet_work.cell(row=rowmax+8, column=colmnr).alignment = Alignment(wrap_text=True)
##    sheet_work.cell(row=rowmax+9, column=colmnr).alignment = Alignment(wrap_text=True)
##    sheet_work.cell(row=rowmax+10, column=colmnr).alignment = Alignment(wrap_text=True)
